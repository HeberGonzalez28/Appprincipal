...
public class ActivityReadFoto extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, RestApiMethods.EndpointGetPerson, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            mAdapter = new CustomBaseAdapter(ActivityReadFoto.this, R.layout.item_row, mList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ActivityReadFoto.this, "Error en la solicitud HTTP", Toast.LENGTH_SHORT).show();
            }
        });
